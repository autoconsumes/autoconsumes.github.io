...
![]({{ fig.url }}f00){ width="300",align=left } 
![]({{ fig.url }}f01){ width="300",align=right }
![]({{ fig.url }}f02){ width="300",align=left }
![]({{ fig.url }}f03){ width="300",align=right }
![]({{ fig.url }}f04){ width="300",align=left }
